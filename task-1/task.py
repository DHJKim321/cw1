...
if __name__ == "__main__":
    ...
    for D in dimensions:
        ...
        print(f"Cosine (Stream): {cosine_api_stream_list.median()}")
        print(f"Cosine (Without Stream): {cosine_api_list.median()}")
        print(f"L2: {l2_api_list.median()}")
        print(f"Dot: {dot_api_list.median()}")
        print(f"Manhattan: {manhattan_api_list.median()}")
        print("----------------------------------------")
        print("Absolute Runtime Values (Kernel)")
        print(f"Cosine (Stream): {cosine_kernel_stream_list.median()}")
        print(f"Cosine (Without Stream): {cosine_kernel_list.median()}")
        print(f"L2: {l2_kernel_list.median()}")
        print(f"Dot: {dot_kernel_list.median()}")
        print(f"Manhattan: {manhattan_kernel_list.median()}")
        print("----------------------------------------")
        print("Differences in Speed (Positive means API is faster than Kernel)")
        print(f"Cosine Difference: {cosine_kernel_list.median()-cosine_api_list.median()}")
        print(f"Cosine Difference (Streams): {cosine_kernel_stream_list.median()-cosine_api_stream_list.median()}")
        print(f"L2 Difference: {l2_kernel_list.median()-l2_api_list.median()}")
        print(f"Dot Difference: {dot_kernel_list.median()-dot_api_list.median()}")
        print(f"Manhattan Difference: {manhattan_kernel_list.median()-manhattan_api_list.median()}")
        print("----------------------------------------")
    ...
    for D in dimensions:
        ...
        for i in range(N):
            ...
            manhattan_gpu[i] = gpu
            manhattan_cpu[i] = cpu
        print(f"Cosine CPU: {cosine_cpu.median()}")
        print(f"Cosine GPU: {cosine_gpu.median()}")
        print(f"Cosine CPU - GPU: {(cosine_cpu.median() - cosine_gpu.median()).item()}")
        print(f"L2 CPU: {l2_cpu.median()}")
        print(f"L2 GPU: {l2_gpu.median()}")
        print(f"L2 CPU - GPU: {(l2_cpu.median() - l2_gpu.median()).item()}")
        print(f"Dot CPU: {dot_cpu.median()}")
        print(f"Dot GPU: {dot_gpu.median()}")
        print(f"Dot CPU - GPU: {(dot_cpu.median() - dot_gpu.median()).item()}")
        print(f"Manhattan CPU: {cosine_cpu.median()}")
        print(f"Manhattan GPU: {manhattan_gpu.median()}")
        print(f"Manhattan CPU - GPU: {(manhattan_cpu.median() - manhattan_gpu.median()).item()}")
        print("----------------------------------------")
